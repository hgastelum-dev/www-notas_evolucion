...
<div class="row g-3">
  ...
  {{--<div class="col-md-5">
    <label for="repeat_password" class="form-label">Favor de confirmar su contrase&ntilde;a</label>
  ...
  <div class="col-md-12">
  	...
  	<p>
  		-
  		{{--<span style="font-size: 16px;" class="badge bg-success"><i class="fa-solid fa-check"></i> verUsuarios</span>
  		<span style="font-size: 16px;" class="badge bg-success"><i class="fa-solid fa-check"></i> crearUsuarios</span>
  		<span style="font-size: 16px;" class="badge bg-success"><i class="fa-solid fa-check"></i> editarUsuarios</span>--}}
  	</p>
  </div>
</div>
